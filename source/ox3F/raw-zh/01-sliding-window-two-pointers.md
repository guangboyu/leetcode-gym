![滑动窗口题单 双指针题单 力扣题目 灵茶山艾府 灵神 灵神题单](https://pic.leetcode.cn/1718242805-sqSjqc-lc1456.png)
...
- [2200. 找出数组中的所有 K 近邻下标](https://leetcode.cn/problems/find-all-k-distant-indices-in-an-array/) 做到 $\mathcal{O}(n)$
...
- [2062. 统计字符串中的元音子字符串](https://leetcode.cn/problems/count-vowel-substrings-of-a-string/) 做到 $\mathcal{O}(n)$
...
- [3859. 统计包含 K 个不同整数的子数组](https://leetcode.cn/problems/count-subarrays-with-k-distinct-integers/) 2302
...
- [3865. 反转 K 个子数组](https://leetcode.cn/problems/reverse-k-subarrays/)（会员题）
...
- [2824. 统计和小于目标的下标对数目](https://leetcode.cn/problems/count-pairs-whose-sum-is-less-than-target/) 非暴力做法
...
- [1861. 旋转盒子](https://leetcode.cn/problems/rotating-the-box/) 1537
...
- [830. 较大分组的位置](https://leetcode.cn/problems/positions-of-large-groups/) 1252
- [2273. 移除字母异位词后的结果数组](https://leetcode.cn/problems/find-resultant-array-after-removing-anagrams/) 1295
- [2264. 字符串中最大的 3 位相同数字](https://leetcode.cn/problems/largest-3-same-digit-number-in-string/) 1309
...
- [3926. 有效单词计数](https://leetcode.cn/problems/count-valid-word-occurrences/) 1608
