...
- [3840. 打家劫舍 V](https://leetcode.cn/problems/house-robber-v/) 1619
...
- [3938. 矩阵中最大共享路径和](https://leetcode.cn/problems/maximum-path-intersection-sum-in-a-grid/) 2252
...
- [3882. 网格图中最小异或路径](https://leetcode.cn/problems/minimum-xor-path-in-a-grid/) 1771
...
- [3877. 达到目标异或值的最少删除次数](https://leetcode.cn/problems/minimum-removals-to-achieve-target-xor/) 1745
...
- [3946. 购买最多物品数目 I](https://leetcode.cn/problems/maximum-number-of-items-from-sale-i/) 1728
...
- [1774. 最接近目标价格的甜点成本](https://leetcode.cn/problems/closest-dessert-cost/) 非暴力做法
...
- [3939. 统计有根树中不相邻子集的数目](https://leetcode.cn/problems/count-non-adjacent-subsets-in-a-rooted-tree/) 2354
...
- [3836. 恰好 K 个下标对的最大得分](https://leetcode.cn/problems/maximum-score-using-exactly-k-pairs/) 1988
...
- [3920. 删除元素后最大固定点数目](https://leetcode.cn/problems/maximize-fixed-points-after-deletions/) 2264
...
- [3077. K 个不相交子数组的最大能量值](https://leetcode.cn/problems/maximum-strength-of-k-disjoint-subarrays/) 2557 做法不止一种
...
- [3891. 最大化特殊下标数目的最少增加次数](https://leetcode.cn/problems/minimum-increase-to-maximize-special-indices/) 1953
...
- [3872. 替换最多一个元素后的最长等差子数组](https://leetcode.cn/problems/longest-arithmetic-sequence-after-changing-at-most-one-element/) 2042
...
- [3850. 统计结果等于 K 的序列数目](https://leetcode.cn/problems/count-sequences-to-k/) 1965
...
- [3892. 产生至少 K 个峰值的最少操作次数](https://leetcode.cn/problems/minimum-operations-to-achieve-at-least-k-peaks/) 2280
...
用于解决 $[\ell,r]$ 范围内有多少个符合要求的数，或者符合要求的数之和等问题。
...
- [3906. 统计网格路径中好整数的数目](https://leetcode.cn/problems/count-good-integers-on-a-grid-path/) 2160
...
- [3869. 统计区间内奇妙数的数目](https://leetcode.cn/problems/count-fancy-numbers-in-a-range/) 2255
...
- [3871. 统计范围内的逗号 II](https://leetcode.cn/problems/count-commas-in-range-ii/) 做法不止一种
...
- [3883. 统计满足数位和数组的非递减数组数目](https://leetcode.cn/problems/count-non-decreasing-arrays-with-given-digit-sums/) 2172
...
- [3251. 单调数组对的数目 II](https://leetcode.cn/problems/find-the-count-of-monotonic-pairs-ii/) 2323 做法不止一种
- [2478. 完美分割的方案数](https://leetcode.cn/problems/number-of-beautiful-partitions/) 2344
- [837. 新 21 点](https://leetcode.cn/problems/new-21-game/) 2350 也可以用滑动窗口
...
- [3333. 找到初始输入字符串 II](https://leetcode.cn/problems/find-the-original-typed-string-ii/) 2629 做法不止一种
- [2902. 和带限制的子多重集合的数目](https://leetcode.cn/problems/count-of-sub-multisets-with-bounded-sum/) 2759
- [1977. 划分数字的方案数](https://leetcode.cn/problems/number-of-ways-to-separate-numbers/) 2817
- [3130. 找出所有稳定的二进制数组 II](https://leetcode.cn/problems/find-all-possible-stable-binary-arrays-ii/) 2825 做法不止一种
...
- [2463. 最小移动总距离](https://leetcode.cn/problems/minimum-total-distance-traveled/) 做到 $\mathcal{O}(nm)$
- [3117. 划分数组得到最小的值之和](https://leetcode.cn/problems/minimum-sum-of-values-by-dividing-array/) 2735
...
- [1626. 无矛盾的最佳球队](https://leetcode.cn/problems/best-team-with-no-conflicts/) 2027
- [2407. 最长递增子序列 II](https://leetcode.cn/problems/longest-increasing-subsequence-ii/) 2280
- [3915. 距离至少为 K 的交替子序列的最大和](https://leetcode.cn/problems/maximum-sum-of-alternating-subsequence-with-distance-at-least-k/) 2288
- [2770. 达到末尾下标所需的最大跳跃次数](https://leetcode.cn/problems/maximum-number-of-jumps-to-reach-the-last-index/) 做到 $\mathcal{O}(n\log n)$
- [2926. 平衡子序列的最大和](https://leetcode.cn/problems/maximum-balanced-subsequence-sum/) 2448 LIS 最大和
...
- [3929. 最小分割分数 II](https://leetcode.cn/problems/minimum-partition-score-ii/)（会员题）同 3826 题
...
- [3916. 锯齿形数组的总数 III](https://leetcode.cn/problems/number-of-zigzag-arrays-iii/)（会员题）拉格朗日插值
...
- [3949. 子树反转和 II](https://leetcode.cn/problems/subtree-inversion-sum-ii/)（会员题）
...
- [3862. 找出最小平衡下标](https://leetcode.cn/problems/find-the-smallest-balanced-index/) 1697
