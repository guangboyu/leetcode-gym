![贪心题单 贪心题目 力扣贪心题单 leetcode贪心 greedy 灵茶山艾府 灵神 灵神题单](https://pic.leetcode.cn/1719584528-kEceMX-greedy-vs-dp-c.jpg)
...
- [3849. 重新排列后的最大按位异或值](https://leetcode.cn/problems/maximum-bitwise-xor-after-rearrangement/) 1556
...
- [1727. 重新排列后的最大子矩阵](https://leetcode.cn/problems/largest-submatrix-with-rearrangements/) 1927 可以优化到 $\mathcal{O}(mn)$ 时间
...
- [3474. 字典序最小的生成字符串](https://leetcode.cn/problems/lexicographically-smallest-generated-string/) 2605 结论好猜，如何证明？
...
- [2087. 网格图中机器人回家的最小代价](https://leetcode.cn/problems/minimum-cost-homecoming-of-a-robot-in-a-grid/) 1744
...
- [2840. 判断通过操作能否让字符串相等 II](https://leetcode.cn/problems/check-if-strings-can-be-made-equal-with-operations-ii/) 1486
...
- [3868. 通过交换使数组相等的最小花费](https://leetcode.cn/problems/minimum-cost-to-equalize-arrays-using-swaps/) 1579
- [3857. 拆分到 1 的最小总代价](https://leetcode.cn/problems/minimum-cost-to-split-into-ones/) 做到 $\mathcal{O}(1)$
...
- [1622. 奇妙序列](https://leetcode.cn/problems/fancy-sequence/) 2476
...
- [3871. 统计范围内的逗号 II](https://leetcode.cn/problems/count-commas-in-range-ii/) 1381
...
- [3855. 给定范围内 K 位数字之和](https://leetcode.cn/problems/sum-of-k-digit-numbers-in-a-range/) 2085
...
- [3876. 构造奇偶一致的数组 II](https://leetcode.cn/problems/construct-uniform-parity-array-ii/) 1444
...
- [3863. 将一个字符串排序的最小操作次数](https://leetcode.cn/problems/minimum-operations-to-sort-a-string/) 1860
- [3440. 重新安排会议得到最多空余时间 II](https://leetcode.cn/problems/reschedule-meetings-for-maximum-free-time-ii/) 1998
- [3886. 可排序整数求和](https://leetcode.cn/problems/sum-of-sortable-integers/) 1999
...
- [3854. 使数组奇偶交替的最少操作](https://leetcode.cn/problems/minimum-operations-to-make-array-parity-alternating/) 2095
...
- [2946. 循环移位后的矩阵相似检查](https://leetcode.cn/problems/matrix-similarity-after-cyclic-shifts/) 1406 结论
...
- [1041. 困于环中的机器人](https://leetcode.cn/problems/robot-bounded-in-circle/) 1521 如何证明结论？
