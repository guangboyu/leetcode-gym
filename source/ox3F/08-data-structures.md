![数据结构题单 数据结构入门 数据结构新手教程 数据结构题目 力扣数据结构 leetcode数据结构 灵茶山艾府 灵神 灵神题单](https://pic.leetcode.cn/1713836847-cDYwhf-Programming.jfif)
...
- [3837. 相等元素的延迟计数](https://leetcode.cn/problems/delayed-count-of-equal-elements/)（会员题）
- [3907. 统计具有相反奇偶性的较小元素](https://leetcode.cn/problems/count-smaller-elements-with-opposite-parity/)（会员题）
...
- [3917. 统计下标的相反奇偶性得分](https://leetcode.cn/problems/count-indices-with-opposite-parity/) 做到 $\mathcal{O}(n)$
- [2078. 两栋颜色不同且距离最远的房子](https://leetcode.cn/problems/two-furthest-houses-with-different-colors/) 做到 $\mathcal{O}(n)$
...
- [560. 和为 K 的子数组](https://leetcode.cn/problems/subarray-sum-equals-k/) 我的题解包含**变形题**
...
- [3900. 一次交换后的最长平衡子串](https://leetcode.cn/problems/longest-balanced-substring-after-one-swap/) 2135
...
- [3937. 使数组变为模交替数组的最少操作次数 I](https://leetcode.cn/problems/minimum-operations-to-make-array-modulo-alternating-i/) 做到 $\mathcal{O}(n\log n)$
...
- [3919. 在下标间移动的最小代价](https://leetcode.cn/problems/minimum-cost-to-move-between-indices/) 1777
...
- [3914. 使数组非递减需要的最小累计值](https://leetcode.cn/problems/minimum-operations-to-make-array-non-decreasing/) 1662 差分思想
...
- [1871. 跳跃游戏 VII](https://leetcode.cn/problems/jump-game-vii/) 1896 做法不止一种
...
- [3888. 使所有网格元素相等的最小操作次数](https://leetcode.cn/problems/minimum-operations-to-make-all-grid-elements-equal/)（会员题）
...
- [394. 字符串解码](https://leetcode.cn/problems/decode-string/) 用栈模拟递归
...
- [3851. 不违反限制的最大请求数](https://leetcode.cn/problems/maximum-requests-without-violating-the-limit/)（会员题）
...
关于单调队列优化 DP，见 [动态规划题单](https://leetcode.cn/circle/discuss/tXLS3i/) 的「**§11.3 单调队列优化 DP**」。
...
- [1388. 3n 块披萨](https://leetcode.cn/problems/pizza-with-3n-slices/) 做到 $\mathcal{O}(n\log n)$
- [3892. 产生至少 K 个峰值的最少操作次数](https://leetcode.cn/problems/minimum-operations-to-achieve-at-least-k-peaks/) 做到 $\mathcal{O}(n\log n)$
...
- [3885. 设计事件管理器](https://leetcode.cn/problems/design-event-manager/) 1548
...
- [3043. 最长公共前缀的长度](https://leetcode.cn/problems/find-the-length-of-the-longest-common-prefix/) 非暴力做法
...
- [3551. 数位和排序需要的最小交换次数](https://leetcode.cn/problems/minimum-swaps-to-sort-by-digit-sum/) 1507 置换环
- [2471. 逐层排序二叉树所需的最少操作数目](https://leetcode.cn/problems/minimum-number-of-operations-to-sort-a-binary-tree-by-level/) 1635 置换环
...
- [778. 水位上升的泳池中游泳](https://leetcode.cn/problems/swim-in-rising-water/)
- [3695. 交换元素后的最大交替和](https://leetcode.cn/problems/maximize-alternating-sum-using-swaps/) 1984 证明
...
- [3873. 添加一个点后可激活的最大点数](https://leetcode.cn/problems/maximum-points-activated-with-one-addition/) 类似 947 题
...
- [3887. 增量偶权环查询](https://leetcode.cn/problems/incremental-even-weighted-cycle-queries/) 2128
...
- [3915. 距离至少为 K 的交替子序列的最大和](https://leetcode.cn/problems/maximum-sum-of-alternating-subsequence-with-distance-at-least-k/) 2288 值域树状数组
...
- [3841. 查询树上回文路径](https://leetcode.cn/problems/palindromic-path-queries-in-a-tree/) 2384 差分树状数组
...
- [308. 二维区域和检索 - 矩阵可修改](https://leetcode.cn/problems/range-sum-query-2d-mutable/)（会员题）二维树状数组
...
- [3901. 好子序列查询](https://leetcode.cn/problems/good-subsequence-queries/) 2545
...
- [2770. 达到末尾下标所需的最大跳跃次数](https://leetcode.cn/problems/maximum-number-of-jumps-to-reach-the-last-index/) 做到 $\mathcal{O}(n\log n)$
...
- [3933. 矩阵中的局部最大值 II](https://leetcode.cn/problems/largest-local-values-in-a-matrix-ii/) **模板题**
...
- [3943. 递增后的数对数量](https://leetcode.cn/problems/number-of-pairs-after-increment/) 2410

### §10.2 根号分解（Sqrt Decomposition）
