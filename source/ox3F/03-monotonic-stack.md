![单调栈题单 单调栈入门 单调栈题目 单调栈教程 leetcode单调栈 灵茶山艾府 灵神 灵神题单](https://pic.leetcode.cn/1711714526-rMdiIh-t3-c.png)
...
- [1130. 叶值的最小代价生成树](https://leetcode.cn/problems/minimum-cost-tree-from-leaf-values/) 做到 $\mathcal{O}(n)$
...
- [1340. 跳跃游戏 V](https://leetcode.cn/problems/jump-game-v/) 做到 $\mathcal{O}(n)$
...
- [1727. 重新排列后的最大子矩阵](https://leetcode.cn/problems/largest-submatrix-with-rearrangements/) 1927 注：不是单调栈，但有一些共同的思路
...
- [3878. 统计好子数组](https://leetcode.cn/problems/count-good-subarrays/) 2230
